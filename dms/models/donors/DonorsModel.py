...
class DonorsModel(db.Model):
    ...
    date_of_anniversary = db.Column(db.DateTime, unique=False, nullable=False)
    ...
    reference_id = db.Column(db.Integer, db.ForeignKey('references.id'), unique=False, nullable=False)
    ...
    state_id = db.Column(db.Integer, db.ForeignKey('states.id'), unique=False, nullable=False)
    country_id = db.Column(db.Integer, db.ForeignKey('country.id'), unique=False, nullable=False)
