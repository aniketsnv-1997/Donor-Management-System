...
#
#         return {"message": "There are no countries present in the system!"}, 401
#
#
...
#                     "name": country.country_name,
#                     "create_date": str(country.create_date),
#                     "update_date": str(country.update_date),
#                 },
#                 200,
#             )
#
#         return {"message": f"No country with id {_id} available in the system!"}, 401
#
#     def post(self):
...
#             return (
#                 {
#                     "message": f"Country {data['country_name']} is already present in the system!"
#                 },
#                 401,
#             )
#
...
#             )
#
#         return {"message": "No such country exists in the system!"}, 401
